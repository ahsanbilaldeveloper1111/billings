...
export const modalPanelBaseClass =
  "relative z-10 flex flex-col overflow-hidden rounded-2xl border border-zinc-200/70 bg-white shadow-[0_24px_64px_-16px_rgba(15,23,42,0.18)] ring-1 ring-teal-900/[0.06] dark:border-zinc-800/80 dark:bg-zinc-950 dark:shadow-[0_28px_72px_-20px_rgba(0,0,0,0.65)] dark:ring-white/[0.06]";
...
export const modalFooterClass =
  "flex shrink-0 justify-end gap-2 border-t border-zinc-200/65 bg-zinc-50/80 px-5 py-3.5 dark:border-zinc-800/80 dark:bg-zinc-900/40 sm:px-6";
